...
///扫码区域动画效果
public enum KYScanViewAnimationStyle {
...
///扫码区域4个角位置类型
public enum KYScanViewPhotoframeAngleStyle {
    case Inner//内嵌，一般不显示矩形框情况下
    case Outer//外嵌,包围在矩形框的4个角
    case On   //在矩形框的4个角上，覆盖
}

public struct KYScanViewStyle {
    ...
    /**
     @brief  扫码区域的4个角类型
     */
    public var photoframeAngleStyle = KYScanViewPhotoframeAngleStyle.Outer
    ...
    /**
     @brief  扫码动画效果:线条或网格
     */
    public var anmiationStyle = KYScanViewAnimationStyle.LineMove
